...
window.PR_ROTEIROS_DEFAULT = {
  ...
  odonto: { label: 'Odontológica', items: [
    ...
    'Linfonodos: aumento de volume / fístula',
    'Lábios: aspecto, integridade, lesões',
    'Saliva: consistência, volume, coloração (normal / sanguinolenta / espumosa / viscosa)',
    'Mucosas: coloração, umidade, lesões, ulcerações',
    'Oclusão: normal / maloclusão (descrever)',
    'Avaliação intraoral: arcada superior — dentes afetados, lesões, tártaro por região',
    'Avaliação intraoral: arcada inferior — dentes afetados, lesões, tártaro por região',
    'Índices periodontais: profundidade de bolsa (mm), mobilidade dentária (grau 0–3), índice gengival',
    'Procedimentos realizados: tipo de procedimento, dentes tratados (numeração Triadan), materiais usados',
    'Diagnóstico dental: doença periodontal / fratura / EOTRH / reabsorção / maloclusão / outras alterações',
    'Outros achados extra-orais',
  ] },
  /* ─── DERMATOLÓGICA ─────────────────────────────────────────────────── */
  derma: { label: 'Dermatológica', items: [
    ...
    'Escala de prurido PVAS — avaliação clínica: 0 (sem prurido) → 10 (contínuo e intenso)',
  ...
  orto: { label: 'Ortopédica', items: [
    ...
    'Plano terapêutico: conservador (repouso, AINE, fisioterapia, condroprotettores) vs cirúrgico (especificar procedimento)',
  ] },
  ...
  neuro: { label: 'Neurologia', items: [
    ...
    'Nervos cranianos — I: resposta olfatória (algodão com álcool)',
    'Nervos cranianos — IV / VI: movimentos oculares, estrabismo, nistagmo posicional',
    ...
    'Diagnóstico diferencial: lista de hipóteses diferenciais em ordem de probabilidade',
    'Plano diagnóstico: exames complementares solicitados (hemograma, bioquímico, RM, TC, LCR)',
  ...
  nutri: { label: 'Nutrição', items: [
    ...
    'Meta de peso ideal e prazo estimado para atingi-la',
    'Prazo de retorno para reavaliação nutricional (semanas)',
  ] },
};
...
window.PR_ANAMNESE_BY_MODEL = {
  geral: [
    ...
    { k: 'tosse',        q: 'Tosse?',                                    type: 'quick', opts: ['Sim, frequente', 'Sim, ocasional', 'Não', 'Tosse produtiva'] },
    { k: 'dispneia',     q: 'Dispneia / dificuldade respiratória?',      type: 'quick', opts: ['Sim', 'Não', 'Eventual', 'Respiração ruidosa'] },
    { k: 'acesso_rua',   q: 'Acesso à rua / área externa?',              type: 'quick', opts: ['Sim, livre', 'Sim, supervisionado', 'Não', 'Área comum condôminio'] },
  ...
  odonto: [
    { k: 'queixa',           q: 'Queixa principal',                                      type: 'text' },
    { k: 'halitose',         q: 'Halitose percebida?',                                   type: 'quick', opts: ['Sim, intensa', 'Sim, leve', 'Não percebida', 'Não sabe'] },
    { k: 'mastigacao',       q: 'Dificuldade de mastigação?',                            type: 'quick', opts: ['Sim', 'Não', 'Come devagar', 'Deixa cair comida'] },
    { k: 'sangramento',      q: 'Sangramento gengival?',                                 type: 'quick', opts: ['Sim, frequente', 'Eventual', 'Não', 'Não observado'] },
    { k: 'ptialismo',        q: 'Ptialismo (salivação excessiva)?',                      type: 'quick', opts: ['Sim', 'Não', 'Eventualmente'] },
    { k: 'anorexia_dental',  q: 'Redução de apetite relacionada à boca?',               type: 'quick', opts: ['Sim', 'Não', 'Come menos', 'Parou de comer ração seca'] },
    { k: 'historicoDental',  q: 'Histórico dental',                                      type: 'text' },
    { k: 'historicoAnest',   q: 'Histórico anestésico',                                  type: 'text' },
    { k: 'alimentacao',      q: 'Alimentação',                                            type: 'quick', opts: ['Ração seca', 'Ração úmida', 'Alimentação natural', 'Caseira'] },
    { k: 'brinquedosDuros',  q: 'Oferece ossos, petiscos ou brinquedos duros?',          type: 'quick', opts: ['Não', 'Sim'] },
    { k: 'brinquedosQuais',  q: 'Se sim, quais?',                                        type: 'text' },
    { k: 'higiene',          q: 'Higiene oral — frequência da escovação',                 type: 'quick', opts: ['Diária', '1x por semana', 'Esporádica', 'Nunca'] },
    { k: 'manipulacaoOral',  q: 'Aceita manipular o oral?',                              type: 'quick', opts: ['Sim', 'Não'] },
    { k: 'doencasPreex',     q: 'Doenças pré-existentes / comorbidades',                 type: 'text' },
    { k: 'freqAlimentacao',  q: 'Frequência de alimentação',                             type: 'text' },
    { k: 'obsTutor',         q: 'Observações',                                           type: 'text' },
  ],
  derma: [
